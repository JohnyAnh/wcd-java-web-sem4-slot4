    ...
    <div class="col-lg-6">
      ...
      <form class="mb-3" method="post" enctype = "multipart/form-data">
        ...
        <div class="form-group">
          <label class="form-check-label d-inline-block text-primary"
                 style="width: 100px;">Hinh anh</label><br />
          <div class="form-check form-check-inline">
            <img src="files/${imageLink}"
            class="img-fluid" height="220px" width="220px">
          </div>
        </div>
        <div class="form-group">
          <label class="form-check-label d-inline-block text-primary"
                 style="width: 100px;">Tai Lieu</label><br />
          <span class="text-white bg-dark">${doc}</span>
        </div>
        <hr/>
        <a href="files/${doc}">
        <button type="button" class="btn btn-danger">Tai ve file</button></a>
      </form>
      <h1>${ketqua}</h1>
