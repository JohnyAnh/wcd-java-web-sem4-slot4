...
//
//public class uploadDAO implements DAOInterface<uploadImage> {
//
//	public ArrayList<uploadImage> data = new ArrayList<>();
//
//	@Override
//	public ArrayList<uploadImage> selectAll() {
//		ArrayList<uploadImage> ketQua = new ArrayList<uploadImage>();
//		try {
...
//
//				uploadImage file1 = new uploadImage(1,linkImage);
//
//				ketQua.add(file1);
//			}
//
...
//
//	@Override
//	public uploadImage selectById(uploadImage t) {
//		uploadImage ketQua = null;
//		try {
//			// Bước 1: tạo kết nối đến CSDL
//			Connection con = JDBCUtil.getConnection();
//
...
//			while (rs.next()) {
//
//				String file1 = rs.getString("linkImage");
//
//				ketQua =  new uploadImage(file1);
//
//			}
//
//			// Bước 5:
